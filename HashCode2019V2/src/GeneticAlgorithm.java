...
public class GeneticAlgorithm {
     ...
     */
    public double calcFitness(Individual individual, ArrayList<Vertex> verticies){
        // Get fitness
        Route route = new Route(individual, verticies);
     ...
     * @param verticies the cities being referenced
     */
    public void evalPopulation(Population population, ArrayList<Vertex> verticies){
        double populationFitness = 0;

        // Loop over population evaluating individuals and summing population fitness
        for (Individual individual : population.getIndividuals()) {
            populationFitness += this.calcFitness(individual, verticies);
        }
